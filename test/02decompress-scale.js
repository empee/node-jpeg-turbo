...
var files = {};
files.jahne = jpeg.compress(rawJahne, {width: 1024, height: 1024, format: jpeg.FORMAT_RGBA}).data;
...
describe("Decompress - scale", function() {
...
function runTest(test, callback) {
  ...
  jpeg.decompress(file, test.options, function(err, data) {
    if(test.shouldFail) {
